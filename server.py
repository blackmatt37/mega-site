...
class MainRequestHandler(tornado.web.RequestHandler):
	def get(self):
		...
		#change here
		shell = "<html><head><title>CHANGE ME" + page + "</title><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><!-- Bootstrap --><link href=\"static/css/bootstrap.min.css\" rel=\"stylesheet\" media=\"screen\"></head><body>"
